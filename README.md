...
- <b>"kftodc"</b>  
Syncronizes the contents of custom fields listed in manualfields.json from Keyfactor to DigiCert. If the fields in manualfields.json do not exist in Keyfactor or DigiCert, they are created first. 
- <b>"dctokf"</b>  
