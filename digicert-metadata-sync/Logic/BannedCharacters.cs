...
public class BannedCharacters
{
        ...
        List<string> invalidCharacterDetails, bool noAuto = false)
    {
        foreach (var dcField in input)
        {
            ...
            if (noAuto) fieldName = dcField.KeyfactorMetadataFieldName;
